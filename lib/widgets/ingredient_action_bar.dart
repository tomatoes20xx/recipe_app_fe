...
class IngredientActionBar extends StatefulWidget {
  ...
  @override
  State<IngredientActionBar> createState() => _IngredientActionBarState();
}

class _IngredientActionBarState extends State<IngredientActionBar> {
  ...
  Widget build(BuildContext context) {
    ...
    final count = widget.selectedIngredients.length;
                ...
                children: [
                  ...
                  Expanded(
                    child: OutlinedButton.icon(
                      onPressed: _isLoading ? null : widget.onMarkAsHave,
                  ...
                  Expanded(
                    ...
                    child: FilledButton.icon(
                      onPressed: _isLoading ? null : () => _addToShoppingList(context),
                      icon: _isLoading
                          ? const SizedBox(
                              width: 18,
                              height: 18,
  ...
  Future<void> _addToShoppingList(BuildContext context) async {
    ...
    final items = widget.selectedIngredients.map((ingredient) {
    ...
    await widget.shoppingListController.addItems(items);
